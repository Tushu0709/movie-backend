  ...
  try {
    ...
    const movies = [
      ...
      },
      {
        ...
        poster:
          "https://image.tmdb.org/t/p/w500/ow3wq89wM8qd5X7hFZkIyburMx4.jpg",
      },
      {
      ...
      },
      {
        ...
        poster:
          "https://image.tmdb.org/t/p/w500/39wmItIWsg5sZMyRUKGnSxQb9mn.jpg",
      },
      {
        title: "Parasite",
        rating: 8.5,
    ...
    for (const m of movies) {
      ...
      await Movie.findOneAndUpdate({ title: m.title }, movieData, {
        upsert: true,
        new: true,
      });
    }
